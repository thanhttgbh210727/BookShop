...
namespace Shop.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(ShopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'ShopContext.Book'  is null.");
        }
        ...
        public async Task<IActionResult> Create(IFormFile file, [Bind("Id,title,info,bookquantity,price,cataid,author")] Book book)
        {
            ...
            {
                ModelState.AddModelError("file", "You need to chose an Image");
                return View(book);
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
